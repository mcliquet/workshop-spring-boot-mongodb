...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... arg0) throws Exception{
		...
		CommentDTO c1 = new CommentDTO("Boa viagem mano!", sdf.parse("21/03/2019"), new AuthorDTO(maria));
		CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("22/03/2019"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", sdf.parse("22/03/2019"), new AuthorDTO(alex));
